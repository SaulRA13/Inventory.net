...
namespace ProyectoVenta.Formularios.Salidas
{
    public partial class frmRegistrarSalida : Form
    {
        ...
        private void btnguardarsalida_Click(object sender, EventArgs e)
        {
            ...
            List<Apartado> olista2 = new List<Apartado>();
            ...
            Salida oSalida2 = new Salida()
            {
                ...
                CantidadProductos = cantidad_productos,
                MontoTotal = lbltotal.Text,
                olistaApartado = olista2
            };

            int operaciones2 = SalidaLogica.Instancia.RegistrarApartado(oSalida2, out mensaje);
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            if (txtdoccliente.Text.Trim() == "")
            {
                MessageBox.Show("Debe ingresar el numero del cliente", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            if (txtnomcliente.Text.Trim() == "")
            {
            ...
            int cantidad_productos = 0;
            int idcorrelativo = SalidaLogica.Instancia.ObtenerCorrelativo(out mensaje);
            List<Apartado> olista = new List<Apartado>();
            ...
            Salida oSalida = new Salida()
            {
                ...
                CantidadProductos = cantidad_productos,
                MontoTotal = lbltotal.Text,
                olistaApartado = olista
            };

            int operaciones = SalidaLogica.Instancia.RegistrarApartado(oSalida, out mensaje);
